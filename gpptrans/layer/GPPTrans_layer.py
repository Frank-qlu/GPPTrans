...
from gpptrans.layer.GraphPyramidModule import GraphPyramidPooling
...
class GlobalModel(nn.Module):
    ...
    def __init__(self, dim_h, global_model_type, edge_type, use_edge_attr, edge_attr_type, num_heads,
        ...
        self.graph_pyramid_pooling = GraphPyramidPooling(
    ...
    def forward(self, batch):
        ...
        h = self.graph_pyramid_pooling(adj.to(h.device), h,tsne_vis=True, save_dir="./tsne_scales")
