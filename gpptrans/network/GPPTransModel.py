...
from gpptrans.layer.GPPTrans_layer import GPPTansLayer, SingleLayer
from gpptrans.encoder.ER_edge_encoder import EREdgeEncoder
from gpptrans.encoder.exp_edge_fixer import ExpanderEdgeFixer
...
class FeatureEncoder(torch.nn.Module):
    ...
    def __init__(self, dim_in):
        ...
        if 'GPPTans' in cfg.gt.layer_type:
...
class GPPTransModel(torch.nn.Module):
...
register_network('GPPTransModel', GPPTransModel)
